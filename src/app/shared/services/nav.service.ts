...
export class NavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'Dashboard', path: '/dashboard', icon: 'home', type: 'link', active: true
		},
		{
			headTitle: 'COMPONENTS',
		},
		{
			title: 'Utilities', icon: 'alarm-exclamation', type: 'sub', active: false, children: [
