...
/*RTL Layout End*/
  ...
  myonoffswitch2() {
	...
	// /*Horizontal Style*/
  myonoffswitch3() {
    this.body?.classList.add('light-hormenu');
  ...
  myonoffswitch4() {
    this.body?.classList.add('color-hormenu');
    this.body?.classList.remove('light-hormenu');
    this.body?.classList.remove('dark-hormenu');
    this.body?.classList.remove('gradient-hormenu');
    this.body?.classList.remove('dark-menu');
  ...
  myonoffswitch5() {
    this.body?.classList.add('dark-hormenu');
    this.body?.classList.remove('color-hormenu');
    this.body?.classList.remove('light-hormenu');
    this.body?.classList.remove('gradient-hormenu');
    this.body?.classList.remove('dark-menu');
  ...
  myonoffswitch13() {
    this.body?.classList.add('gradient-hormenu');
    this.body?.classList.remove('dark-hormenu');
    this.body?.classList.remove('color-hormenu');
    this.body?.classList.remove('light-hormenu');
    this.body?.classList.remove('dark-menu');
